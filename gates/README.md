...
→ [pr-size-limits/](pr-size-limits/) — CI configs for GitHub Actions and GitLab
...
| [pr-size-limits/](pr-size-limits/) | 400-line limit with GitHub Actions + GitLab CI configs |
